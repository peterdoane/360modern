...
const HomePage = (props) => (
  <div className={styles.page}>
    ...
    <div className={styles.section}>
      ...
      <p className={styles.sectionText}>We hand-curate modern homes daily from the Multiple Listing Service, saving buyers time and effort while providing unparalleled exposure for Modern home sellers.</p>
...
We live, build, and sell modern.</p>
    ...
    <div className={styles.section}>
      <div className={styles.left}>
        ...
        <p className={styles.sectionText}>The 360°modern community is comprised of architects, Modern furniture and art experts, non-profits, state historical organizations, county historical groups, and contractors. Join us.</p>
      </div>
